...
Latest user steering: do not enter W4A8; discuss W4A16 accuracy recovery first. See docs/W4A16_ACCURACY_RECOVERY_DISCUSSION.md. Proposed first comparison targets GPTQ calibration coverage/budget, not rotation-training text; current act-order and true-sequential quantization already exist. Group128 and AWQ input-channel equalization are conditional discussion alternatives. No EXP230 or model/device work authorized. Both other recipes remain frozen.
