...
# Current closure: EXP-0301 decode alignment repair

All11 initially flagged Qwen B/C decode rows inspected. Qwen0.6 A8/SP2 now uses existing long option65439; generic A16 long decode KV prefetch uses4 for0.6 and7 for1.7, retaining full-M64 residual/Norm parity. All affected recipes passed frozen exact-output/KV checks, shared-source A8 regressions,5 short and10 formal repeat10 paired rounds. 109800 formal full-model RPCs. Same-length prefill/decode confidence guards pass; 8 cross-context decode losses still exceed10%. Qwen0.6 A8/SP2 long prefill passes; Qwen0.6 A16 long prefill remains below gate. No claim that all remaining attention cost is irreducible. Read docs/experiments/EXP-0301-RESULTS.md and MODULES.md for exact rows and attribution. Desktop workbook18 Qwen rows refreshed,2 unchanged Qwen1.7 A8 C notes clarified; Llama data and D preserved. No weights, PPL, quality acceptance or selected-baseline promotion. Historical full-floating failures remain. Source 22fba3060abd606ec33efb7fabb942b33e14a20e on codex/exp-0301-decode-alignment; workspace build1.7B/28. Active none, next302, device free. Evidence ledger d5bb1cee6418430a7da65cd0b4022532b69dc5c6ead60aab5107e48257c50e69.

# Archived checkpoint: EXP-0301 A16 stage
...
# Desktop workbook D policy revised by user
D is now a curated latest/best historical-baseline view ONLY for measured shapes that cannot populate A/B/C. It is no longer an append-only archive. Keep one intact prefill/decode measurement pair per model/recipe; replace superseded versions, remove rows already represented at the same model/recipe/length in A/B/C, and never concatenate independently best metrics or select fastest individual repetitions. Full historical evidence remains in the sealed experiment reports. This user revision supersedes earlier instructions to append replaced rows to D.
Completed workbook cleanup:24 to8 D rows, retaining four Qwen3-1.7B and four Llama3.2-1B short-shape baselines. Removed8 superseded long-shape rows and8 rows duplicated in A. Qwen1.7 SP2 native64+15 refreshed to EXP0297 whole-run1850.732852/47.790575TPS; unchanged native short implementation, not the slower experimental long64 path. A/B/C values and formulas preserved. Desktop workbook saved and visually checked. No new hardware experiment, source change or arithmetic/quality/baseline promotion.

# EXP-0297 completed: Qwen3-1.7B decode optimization
Read docs/experiments/EXP-0297-RESULTS.md and MODULES.md. Source fa7cb9c8e2718c3a965fc75d04544ef79d3a0da3 on codex/exp-0297-qwen17-decode, workspace build1.7B/28. Candidate option65439, parent927; five short and ten paired formal repeat10 complete. Native64+15 and long64+15 measured to separate historical context effects. All independent layer/KV/head/poison and8MiB/no-intermediate-DDR checks pass. Performance gate remains fail; no automatic baseline or model-quality promotion.
Other models and historical D short results unchanged. Latest general two-model migration remains recorded in EXP0296; Qwen1.7 long results are superseded only by this scoped record. No active experiment/device owner, next298. Desktop workbook updated and visually verified: only Qwen1.7 B/C rows replaced, prior EXP0296 rows appended to D (24 history rows total). Original M64+15 history and all other model rows preserved.
...
# EXP0295 checkpoint: 0.6 formal complete,1.7 cache-slot repair
Source9593bfa (only fixture-preparation Python changed from3a72cd5; all four1.7 native binaries hash-identical).0.6 formal complete:536+46=2486.767286/24.840294 TPS;741+3=2410.921075/21.108794;M64 native2939.804052. Parity fails0.846/0.820, matched decode10%guards pass.1.7 native64 passed; audit65-final stopped beforeDSP due absent row-major cache files in native-only frozen package. New immutable *-cache832-a02 fixtures add112empty slots each; all915old payloads unchanged. Old manifests/failure retained. Deployment underway; campaign_resume17_a02.py waits for new staged runtime then performs six checks (audit65-final-a02), five short/ten formal. final-audit-index.json identifies accepted audits. Original campaign.py has exited and must not be restarted. Llama closure_campaign.py waits for1.7 final summary. Experiments remain active; no baseline promotion.

# EXP0295 checkpoint: Qwen0.6 formal campaign starting
Source3a72cd5, build0.6B28, binaries-a5. All six final candidate audits64/65/128/129/536+46/741+3 pass2520 exact layer outputs, allKV/head/poison; sequential native control741 also passes. Same-binary native short M64 checked. Five short rounds then ten formal repeat10 under results/exp0295/campaign.py; next builds/deploys/audits/profiles1.7B. Device exclusively Qwen; Llama formal complete, waiting closure. Frozen1.7 prefixseed verified local/device SHA7683237318d42ac5cc80052fb53619205a3d82a0d1377bcbbaed78d7c7683b91. No final Qwen speed claim yet. Do not duplicate/restart campaign; preserve all tags.
...
AllapprovedA0/A1/A2/A3/A5/A6/A8/A9 finishedbothmodels,A7cites272, canceledW4-to-S8 andintegerresidualnotrun. Finalreport/mnt/d/llm_exp/results/paper-no-rotation-ablation-20260915/REPORT.md; completeMODULE_TABLES.md; figurePNG/SVG/PDF. Campaignledger5c050ce12226744cbe198c280bf6ff97a090e8581f969ad8176593e983b15447. Sourcecopiesdocs/paper_no_rotation_ablations. Fresh-directoryreport/datareproductionexact,visualQApass. Numerical/physicalscopeandallfailuresretained. No quality/PPLclaim orbaselinepromotion.

LatestQwen279: M64+33/cache128,all34hidden/normbytespairedexact,ownactualheadoracle,per-layerKV97and8MiBpass. FFNdisable/allprefill1.07182187CI[1.06991416,1.07439447],decode1.02950600[1.02721909,1.03228662]. Stageledger8d9a848f7133bb7f8dda0dbeedcf378333a1f56ddb4b1918852cc479f0b89590,472files386951723bytes. All10200profilessuccess. All-on1850.73/47.14tps,FFN1726.72/45.79. Do notcomparecross-experimentabsolute tps aspairedgain.

Paperconclusions: pipelinebenefitstable, nativeformat/interactionconditional; SP2costsmallwithfixedFP32residual; copack~1%fullmodelonly; QwenNR64prefillbenefit~1.48%,fixeddecodeinconclusive; LlamaFPvectorsoftmaxbeatsretainedlog2 (selectedEXACT),thusnogenericlog2advantage. IncompleteFARFtimelineN/A; LlamaQKVringmaskinactive. MainM64+15andlongerKVreportedseparately. Qwenfull28CPUtransformerequivalencenotclaimed.

Next action is discuss/use paper results; no remaining approved experiment in this campaign. Read standalone reports rather than older handoff pending lists below.
...
---
Historical context follows; current closure above supersedes older active pointers.
...
---
Historical context follows. Active/current closure above supersedes older pointers.
...
---
Prior context follows; active/next pointers above supersede older sections.
...
---
Historical context follows; current next action is above.
...
**Offline Hadamard R1/R2**: EXP-0219 extends the user-specified mllm Layer-5 fixed Sylvester transform to all 28 layers and complete token boundary. R1 changes residual coordinates; R2 changes V and its persistent cache per head, compensated in O. Fold residual RMSNorm gammas first; Q/K head norms and RoPE stay intact. A/B/C isolates norm folding from rotation. This is fixed offline rotation, not learned SpinQuant or an accepted quality baseline. Other recipes are frozen.

**Rotation provenance**: LPBQ belongs to the upstream POC, not EXP-0219. Recompute every B/C folded weight from Qwen3-origin and requantize with this project's per-channel W4. Reusing upstream folded/quantized tensors is forbidden.

**Completed Fixed R1/R2 Per-Channel Validation**: EXP-0219 has fresh original-weight A/B/C evidence. Fixed H2048/H128 worsens W4F16 NLL from 4.2317 to 8.5625 and short tasks from 8/24 to 0/24; identity folding alone is 5.6017 and 0/24. Unquantized equivalence passes and software/DSP agree on the negative quality outcome. Improved local weight RMSE did not imply improved composed quality. No LPBQ assets were reused; do not misattribute failure to copying grouped weights or generalize it to every rotation. No baseline promotion; other recipes frozen. All 5-short/10-formal speed work is complete.

**Gamma-fold Attribution / R2-only**: EXP-0220 separates real-arithmetic invariance from FP16 rounding and W4 requantization. Gamma scales weight input columns; the existing one-scale-per-output-row quantizer does not commute with this column scaling. Isolate input norm/QKV, post norm/Gate-Up and final norm/head; then R2-only can preserve gamma without the global R1 commutation problem. Host FP16 controls do not modify the frozen F16 recipe.

**Completed Gamma Attribution and R2-only**: EXP-0220 FP16 original/folded quality is unchanged at 22/24 and NLL 3.6344, despite small finite rounding drift. W4 QKV-only folding has the largest isolated NLL regression (5.0649); Gate/Up-only 4.5174 and final-head-only 4.4179 also regress from original 4.2317. Host actual-input projection errors support W4 requantization after input-column gamma scaling as the main folding failure. Losses do not add linearly. Gamma-preserving R2-only still scores 5.6464 and 0/24, with matching software diagnosis and passing FP32 invariance. Fixed H128 R2 is rejected for this quantizer; no general rejection of rotations. Complete quality and 5-short/10-formal speed evidence is retained; other recipes frozen, no baseline promotion. Future full-R1 work needs a new declared quantizer/calibration hypothesis, not repeated fixed rotation or evaluation tuning.

**GPTQ Original/Folded/Rotated**: EXP0221 adds activation-weighted offline error compensation with fixed per-channel W4 scales and independent frozen bilingual training calibration. Compare original, gamma-only and fixed R1/R2 under identical GPTQ settings; no LPBQ, online operator, frozen-recipe change or evaluation tuning.
...
## EXP0232 completed; PC051 ordered sequence closed (2026-09-07)

Fresh AWQ positive input diagonals plus unchanged per-channel GPTQ65536calibration did not improve quality. All1024independent documents/16384targets (frozen primary+reserve) software FP16: F25.132355,C8 28.333026,C64 27.000522,E64 28.058848. E64/F+11.644325% (95%CI+10.010535..13.317941%) fails; E64/C64+3.919649% (CI+2.614865..5.286532%) is worse. C64/F+7.433316% (CI+5.947106..8.967007%) also remains above overall5% acceptance. Allfour compare identical tokens/context/masks; do not compare raw PPL across EXP230/231/232 final datasets/backends.
...
PC052 secondphase nowregistered: unchangedgroup128CPUquantizer expandedtoC64calibration64K. SamePC052pairedpanel,F/C64/G8/G64,noPPLselection. NextEXP235C64sensitivity remainsapproved.
...
PC061 qualifying dense R3 continuation registered. Read docs/experiments/EXP-0247.md; source temporarily parent-bound for branch setup. One real C64 layer0 HMX dense R3 gate; no butterfly, no full-model run or promotion.
...
## Current handoff after EXP0252

Completed fixed NR64 reciprocal + one integer Newton normalization and R3 joint ablation.37,224,464 denominator/exponent entries<=1LSB vs exact, six development controls reproduce, independent128docs/2048targets all8arms completed. Conditional software PPL {"F": 32.210139338951315, "C64": 32.94876092830991, "OFF_wide_sole": 61.64335467418651, "OFF_wide_exact": 53.34454270350036, "OFF_wide_nr64": 53.74792160980847, "R3_wide_sole": 43.53934073385623, "R3_wide_exact": 42.74187304909285, "R3_wide_nr64": 41.725860426711506}. Actual12x9boundary sets raw/prob/AV exact and old controls reproduce; NR64 vs exact probability<=1LSB, scalar/HVX NR64 complete outputs exact. Dense R3 final prefill11LSB SOLE ->7LSB NR64/exact; cosine~0.99432 still fails unchanged gate.5short10formal2970RPC no-R3 NR64 speed gate passes (repeat10 prefill-1.40%,decode+0.69%, both CI include zero). No promotion/slice/full-model DSP PPL or E2E; other recipes frozen. ABI116 experimental layer0 capacity72 cache only. Active none,next253 for discussion; conditional integration approval retained but prerequisites unmet. Report docs/experiments/EXP-0252-RESULTS.md; next docs/W4A8_NEXT_DIRECTION_AFTER_EXP0252.md; source 71f8a62449226127e6befb776abc5f572f1c4a88; ledger c2491088eefd8f96f943be73c63898815697f906a8eab6e898d48639169ccd9c.
...
## Current handoff after EXP0253

Complete floating attention diagnostic finished on fresh128docs/2048targets; all8arms, six exact historical development reproductions,280 numerical cases and independent integrity pass. Fixed U8 QKV + output boundary, FP32 TwoSum standard attention reference; not native FlashAttention. Final conditional software PPL {"F": 26.407341791687603, "C64": 27.331961008641233, "OFF_legacy": 39.0245353053658, "OFF_wide_nr64": 46.391479923426296, "OFF_float_core": 37.56089942299241, "R3_legacy": 31.897286114198955, "R3_wide_nr64": 35.881764504686025, "R3_float_core": 33.043535926419054}. Quality gates {"C64": {"point_pass": false, "confident_pass": false}, "OFF_legacy": {"point_pass": false, "confident_pass": false}, "OFF_wide_nr64": {"point_pass": false, "confident_pass": false}, "OFF_float_core": {"point_pass": false, "confident_pass": false}, "R3_legacy": {"point_pass": false, "confident_pass": false}, "R3_wide_nr64": {"point_pass": false, "confident_pass": false}, "R3_float_core": {"point_pass": false, "confident_pass": false}}. No device work, promotion or other recipe changes; device ABI116 EXP0252 state preserved. Active none,next254. Discuss docs/W4A8_NEXT_DIRECTION_AFTER_EXP0253.md before further method/device work. Result docs/experiments/EXP-0253-RESULTS.md; source 6d130035cf089ba099c8f161799952bf1d70a385; ledger f8dbb4d50965546f69c2ad853bcdd05d49d3fa8c36ce79f0c64d4f967d5bec1d.
...
## Current handoff after EXP0254

Ordered research completed. Two disjoint128doc/2048target panels frozen before inference; joint restoration triage then predeclared downstream branch independently confirmed. Triage {"F": 21.34211023294927, "C64": 22.532612616101396, "B": 25.878157651192183, "J": 26.368808132806105}; confirmation {"F": 27.704302692591753, "C64": 29.257888338855555, "B": 34.12065478677464, "J": 32.62572984205891, "R": 31.25043205734052, "S": 32.94684762439127, "RS": 30.57079886224828, "JR": 31.094948102989655, "JS": 32.587527947983524, "JRS": 30.601240377678216}. Numerical/mixed-cache/hook/count/reproduction/causal/CE/weights/data/independent result checks pass. Restorations FP16 diagnostic only; fixed original W4, other recipes and device ABI116 unchanged. No deployable A8 improvement, hardware speed or promotion inferred. Active none,next255. Discuss concrete repair in docs/W4A8_NEXT_DIRECTION_AFTER_EXP0254.md; ordered research approval retained with separate concrete protocol. Result docs/experiments/EXP-0254-RESULTS.md; source e66af129a2f66930cdcfe0155f53fd93ccd628b4; ledger 0b1a0b0360cb93e0fd2f99fef83b3ba12b065b6a6d682bb0ee871405cfa92ed2.
...
## Current closure EXP0264 (supersedes EXP0263 current status)
...
## Current EXP0265 policy and continuation

PC079 user changes speed eligibility to repeat10 only; repeat1 auxiliary and cannot veto. SealedEXP0264 qualifies on both repeat10 phases undernewpolicy, historicaloriginalclassification preserved. Proceed3layer then28layer R4 text/E2E under docs/experiments/EXP-0265.md. Othernumerical/physical/provenance gates unchanged.

## Current closure EXP0265 (supersedes priorcurrentstatuses)

Source codex/exp-0265-w4u8-r4-fullmodel-e2e 48eb1ea7f9db0eb197a7c7908ab954d5a6635fc5; active none,next266. NativeABI127 runtime0aa5d3ba9b725039b0a99a11e4879c5f5ead62f1; source/memory clean andpushed. Bootstrap andauthority beforefuturework; no mllm. Results /mnt/d/llm_exp/results/qwen3-block-htp/exp0265; seal eb81fda764aebfb08411069e4266784ac781be9b0c56a23633e9b19131fed2ee, 521files. Read sourceEXP-0265-RESULTS.md/PROFILE.md and resultMODULE_TABLE.md/text_output.json.

PC079 explicituser amendment is persistent: formal pairedrepeat10 Hostwall controls speedacceptance and10percent escalation forbothprefill/decode; repeat1 auxiliaryonly, neverveto. Othernumerical/physical/provenance/determinism gates unchanged. SealedEXP0264 originalinconclusive classification preserved, newpolicy reevaluation eligible. No repeatof singlelayercampaign.

28 originalDown weights freshlyfolded with idealH12 tensorH512 and RTN[-7,7]/FP32scale-output, no group/mllm/foldedquantweightreuse. Explicit denseHMX factors with frozenFP16rounding and OPT6 registerfusion, no butterfly. OtherC64weights/head/embedding/staticA8unchanged. Layer0 reproducesEXP0261 exact; all28float64invariance/independentunpack and65536entryDecimal80/mpmath100 FP16LUT audits pass. Changed87files,906/packageverifiedlocalremote. ExistingrotatedR3EOSprefix remainsfrozendiagnosticseed, NOT regeneratedthroughR4. NoR4calibration orqualityoptimizedDown.

Threeconsecutive layers M64+8continuousM1: noR4matches sealedEXP0259; OPT3/OPT6/repeatexact capturedlivehidden/R3/R4/middleDown/KV. IndependentFloat64factor andSDKDown/residual lastlayerreferencepass; conditionalidealR4<=1LSB/cos>=.999. Full28layers OPT3/OPT6/audit/repeat16feedbackselectedtokens/codes exact. Untimedallfinite63488FP16quantization perlayer perstep, includingfullstackaudit. KnownidealR3wholelayerfailure unchanged underperformance-only scope; selectedmaximacodes not fullvocablogitequivalence.

5short10formal alternatepaired repeat1/10,5280fullmodelRPCs and147840layerledgers independentlychecked. OneFastRPC/fullstep,8MiB requested/granted,zero timedintermediateDDR/spill/audit/interlayerhiddenDDR,correctpersistentKV andoneHMXowner. Repeat10speedeligible=True. Fixedroundscomplete,no optionalresampling.

r1_prefill_ns: control39029.218500us -> R441944.557500us, pairedratio1.075804722 CI[1.0678695196511312, 1.0818865016740276]; auxiliaryonly.
r1_decode_ns: control21961.052033us -> R422550.965233us, pairedratio1.030128579 CI[1.007420096488719, 1.0596886507091443]; auxiliaryonly.
r10_prefill_ns: control37433.520700us -> R440478.950500us, pairedratio1.080156398 CI[1.0710327843754035, 1.0861324020912513]; gate.
r10_decode_ns: control20539.982453us -> R421709.915453us, pairedratio1.044334083 CI[1.0330432664064995, 1.0592652244912402]; gate.

True E2E,64prefilltokens includesEOS;15continuousdecode afterfirstoutput,16totalselectedoutputs. FullHost embedding/28layers/finalnorm/nativeW4head/greedy/FastRPC, tokenizer/ADB/loadingexcluded. generationloopaddsHostloop/serialization,coldstartupseparate.
a0_r10: prefill1709.697587tok/s (37433.520700us); decode48.685533tok/s (308099.736800us/15); totalHost46.307068tok/s; loop44.662209tok/s.
...
## EXP0311 active
User requests simultaneous HVX/HMX bandwidth characterization; EXP0310 separate peaks alone cannot establish independence. Device owned EXP0311, source codex/exp-0311-vtcm-concurrent-bandwidth.
