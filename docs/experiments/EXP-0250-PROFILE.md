# EXP-0250 complete profiling record — fixed-prefix software U8 cache diagnostics

PC064 scope: masked raw-score maximum and signed16 difference software PPL ablation on frozen C64 per-channel W4, with static U8 online activations and real U8 software KV storage. No DSP binary, model package, deployment, device invocation or timed hardware run changed. Repeat1/repeat10, five short/ten formal device rounds: N/A.
