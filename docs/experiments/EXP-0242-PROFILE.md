# EXP-0242 complete profiling record — fixed C64 software A8 diagnostics

PC057 scope: static activation QDQ, error localization and clipping on fixed C64 per-channel W4. No DSP binary, model package, deployment, device invocation or timed hardware run changed. Repeat1/repeat10, five short/ten formal device rounds: N/A.
