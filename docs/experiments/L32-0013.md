...
## Historical implementation checkpoint (superseded)

The following checkpoint predates completed initial training and the durable
automatic pipeline. For current jobs and progress, read docs/SESSION_HANDOFF.md.
