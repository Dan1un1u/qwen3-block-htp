# Qwen3 freeze and Llama handoff

User froze Qwen3 research. Source /home/daniuniu/work/qwen3-block-htp remains codex/exp-0265-w4u8-r4-fullmodel-e2e at 48eb1ea7f9db0eb197a7c7908ab954d5a6635fc5. No SP2 or other new Qwen3 experiment is active.

Continue new model work from /home/daniuniu/work/llama32-htp (OFF) or /home/daniuniu/work/llama32-htp-rotation (R3 default, R4 optional), using /home/daniuniu/work/llama32-htp-project-memory/scripts/bootstrap.sh WORKTREE and its four authority files. The new authority owns all future Llama experiments, beginning L32-0001. Exact checkpoint remains to be selected; this task only organized source/baselines and did not implement inference.
