...
![完整模型配对成本](/mnt/d/llm_exp/results/paper-no-rotation-ablation-20260915/paired_representation_costs.png)
...
[全部实验完整模块表合订本](/mnt/d/llm_exp/results/paper-no-rotation-ablation-20260915/MODULE_TABLES.md)
