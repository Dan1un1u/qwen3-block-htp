...
cell="${1:?EXP-0210 cell required}"
case "${cell}" in
    o8) o_batch=8; o_single_dma=0 ;;
    o16) o_batch=16; o_single_dma=1 ;;
    *) printf 'invalid EXP-0210 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
...
QBH_EXP0176_O_BATCH_TILES="${o_batch}" \
...
QBH_W4U8_DECODE_DIRECT_N_O_SINGLE_DMA="${o_single_dma}" \
