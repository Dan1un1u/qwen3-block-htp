...
f16f16_projection_mode="${6:-batch2}"
...
mlp_mode="${12:-control}"
mlp_hvx_contexts="${13:-1}"
mlp_chunk_vectors="${14:-64}"
attention_pipeline_mode="${15:-control}"
attention_hvx_contexts="${16:-1}"
qkv_batch_mode="${17:-control}"

if [[ "${DEPLOY_EXP0037:-0}" == "1" ]]; then
