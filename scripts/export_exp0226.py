...
from learned_rotation_exp0226 import RESULT,OUTPUT,PLAN,fold,orthogonality
...
def prepare(v):
    ...
    manifest.update(experiment='EXP-0226',variant=v,transform='learned_offline_R1R2_fresh_original',rotation_checkpoint_sha256=ev.digest(rotation_checkpoint),
