#!/usr/bin/env python3
"""Validate and summarize EXP-0205 direct-W4 Down batch4 evidence."""
...
EXPERIMENT = 205
LAYERS = 28
DOWN_BATCHES = {CONTROL: 2, CANDIDATE: 4}
DOWN_COMMANDS = {CONTROL: 896, CANDIDATE: 448}
...
def main() -> None:
    ...
    report = [
        "# EXP-0205 direct-W4 Down batch4 report",
        "",
        f"Source commit: `{args.source_commit}`",
        "",
        "Both cells inherit the evidence-valid EXP-0204 candidate. The only "
        "runtime difference is direct-W4 decode Down projection batch2 versus "
        "batch4 command granularity.",
        "",
        "## End-to-end gate",
        "",
        "| Metric | Down batch2 control | Down batch4 candidate | Change |",
        "|---|---:|---:|---:|",
        ...
        *pair_rows,
        ...
        "",
        "| Module | Down batch2 control | Down batch4 candidate | Candidate speed change |",
        "|---|---:|---:|---:|",
        *module_rows,
