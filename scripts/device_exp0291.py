"""EXP0291 provenance-sealed Qwen3-0.6B A16 device checks."""
import argparse,subprocess,shutil,shlex,statistics,json,struct,os
import numpy as np
from common_exp0289 import *
R=Path("/mnt/d/llm_exp/results/qwen3-block-htp/exp0291")
def preflight():
