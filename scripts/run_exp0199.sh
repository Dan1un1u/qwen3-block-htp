...
cell="${1:?EXP-0199 cell required}"
case "${cell}" in
    batch8) qkv_batch=8 ;;
    batch16) qkv_batch=16 ;;
    *) printf 'invalid EXP-0199 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
EXP0173_REMOTE_ROOT=/data/local/tmp/qwen3-block-htp/exp0173-exp0199-qkv-batch16 \
