...
def main():
 ...
 text.extend(['','## R3 diagnostics','','Untimed plain dense HMX R3 numerical audit; not valid formal timing evidence.',json.dumps(details,indent=2),'','E2E prefill/decode token/s: N/A. Device PPL: N/A. Full-model work is outside PC066. The score repair does not establish model quality acceptance.'])
