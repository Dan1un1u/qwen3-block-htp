...
case "${mode}" in
    control)
        remote_root="${EXP0050_CONTROL_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0050-control}"
        ;;
    candidate)
        remote_root="${EXP0050_CANDIDATE_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0050-candidate}"
        ;;
    *)
