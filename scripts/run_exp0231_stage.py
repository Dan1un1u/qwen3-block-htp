...
R=Path('/mnt/d/llm_exp/results/qwen3-block-htp/exp0231')
...
def main():
    ...
    modules={'data':('data_exp0231.py',['prepare']),'audit':('data_exp0231.py',['audit']),
             'oracle':('group_exp0231.py',['oracle']),'export':('export_exp0231.py',[]),
             'evaluate':('evaluate_exp0231.py',[]),'summary':('summarize_exp0231.py',[])}
    ...
    archive=Path('/mnt/d/llm_exp/models/qwen3-block-htp/exp0231/artifacts')/head/'source.tar'
