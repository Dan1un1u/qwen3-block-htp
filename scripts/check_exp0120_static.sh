...
grep -q 'QBH_BLOCK_EXPERIMENT UINT32_C(120)' \
    "${project_root}/include/block_protocol.h"
...
if grep -RInE 'QnnGraph|QnnContext|QnnBackend|libQnn' \
    ...
    printf 'QNN dependency found in EXP-0120 source\n' >&2
    exit 1
fi
printf '%s\n' '{"experiment":"EXP-0120","static_gate":"pass","recipe":"W4U8","ring8_runtime_selectable":true,"ring16_runtime_selectable":true,"hmx_batch_outputs":8,"persistent_hvx_workers":3,"stream_fence":"single_fence","one_hmx_owner":true,"qnn_dependency":false}'
