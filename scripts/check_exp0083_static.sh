...
grep -q 'header->w4u8_gate_up_batch_n_tiles / 2U' src/dsp/block_imp.c
...
printf '%s\n' \
    '{"experiment":"EXP-0083","static_gate":"pass","block_abi":42,"runtime_telemetry_experiment":83,"gate_up_batch_candidates":[8,16,32],"qnn_dependency":false,"vtcm_request_bytes":8388608,"single_hmx_owner":true}'
