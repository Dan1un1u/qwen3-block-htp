...
grep -q '#define QBH_BLOCK_ABI_VERSION UINT32_C(43)' include/block_protocol.h
...
grep -q 'header->numerical_audit_enabled != 0U ? 1U : 0U' src/dsp/block_imp.c
...
printf '%s\n' \
    '{"experiment":"EXP-0087","stage":"A","static_gate":"pass","block_abi":43,"softmax_row_slices":2,"timeline_audit_only":true,"qnn_dependency":false,"vtcm_request_bytes":8388608,"single_hmx_owner":true}'
