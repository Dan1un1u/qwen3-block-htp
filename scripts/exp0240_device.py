...
RESULT=Path('/mnt/d/llm_exp/results/qwen3-block-htp/exp0240')
ADB='/mnt/c/adb/adb.exe'
REMOTE='/data/local/tmp/qwen3-block-htp/exp0240-layer14'
...
def deploy():
 preflight();stage=MODELS/'exp0240/device';stage.mkdir(exist_ok=True)
