...
def main():
 ...
 old=read(R.parent/'exp0261/summary.json')
 ...
 lines+=['','Historical EXP0261 comparison (separate campaigns, not paired inference):','', '|Mode|Previous R4 us|Optimized R4 us|Observed speedup|','|---|---:|---:|---:|']
