...
cell="${1:?EXP-0189 cell required}"
case "${cell}" in
    full64) swiglu_rows=64 ;;
    row4) swiglu_rows=4 ;;
...
QBH_EXP0189_SWIGLU_ROWS="${swiglu_rows}" \
QBH_EXP0189_SWIGLU_PADDING_POISON="${QBH_EXP0189_SWIGLU_PADDING_POISON:-0}" \
