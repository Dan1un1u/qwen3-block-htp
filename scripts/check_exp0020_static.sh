...
gate.update(
    ...
    direct_dispatch_plan="stream32_gate_hvx2_direct",
    per_worker_spsc_queues=2,
    shared_task_queue_mutex_in_direct_plan=False,
    lockfree_dispatch_plan="stream32_gate_hvx2_lockfree",
    shared_atomic_head=True,
    shared_queue_mutex_in_lockfree_plan=False,
