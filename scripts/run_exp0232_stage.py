...
R=Path('/mnt/d/llm_exp/results/qwen3-block-htp/exp0232')
...
def main():
    ...
    modules={'data':('data_exp0232.py',['prepare']),'audit':('data_exp0232.py',['audit']),
    ...
    archive=Path('/mnt/d/llm_exp/models/qwen3-block-htp/exp0232/artifacts')/head/'source.tar'
