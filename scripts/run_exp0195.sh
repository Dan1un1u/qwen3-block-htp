...
cell="${1:?EXP-0195 cell required}"
case "${cell}" in
    batch16) batch_tiles=16 ;;
    batch32) batch_tiles=32 ;;
    *) printf 'invalid EXP-0195 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
EXP0173_REMOTE_ROOT=/data/local/tmp/qwen3-block-htp/exp0173-exp0195-gate-up-batch32 \
...
QBH_W4U8_DECODE_DIRECT_N_GATE_UP_BATCH_N_TILES="${batch_tiles}" \
