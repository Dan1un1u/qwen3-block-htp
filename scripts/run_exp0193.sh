...
cell="${1:?EXP-0193 cell required}"
case "${cell}" in
    batch2) batch_tiles=2 ;;
    batch4) batch_tiles=4 ;;
    *) printf 'invalid EXP-0193 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
EXP0173_REMOTE_ROOT=/data/local/tmp/qwen3-block-htp/exp0173-exp0193-down-dma4-hmx2 \
...
QBH_W4U8_DECODE_DIRECT_N_DOWN_DMA_BATCH_N_TILES="${batch_tiles}" \
