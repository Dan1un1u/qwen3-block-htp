...
S=Path('/home/daniuniu/work/qwen3-block-htp');R=Path('/mnt/d/llm_exp/results/qwen3-block-htp/exp0281');O=Path('/mnt/d/llm_exp/models/qwen3-block-htp/exp0271');OLD=O.parent/'exp0267';P=O.parent/'exp0257/package'
