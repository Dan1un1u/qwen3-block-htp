...
cell="${1:?EXP-0194 cell required}"
case "${cell}" in
    qkv4) batch_tiles=4 ;;
    qkv8) batch_tiles=8 ;;
    *) printf 'invalid EXP-0194 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
EXP0173_REMOTE_ROOT=/data/local/tmp/qwen3-block-htp/exp0173-exp0194-qkv-batch8 \
...
QBH_W4U8_DECODE_DIRECT_N_QKV_BATCH_N_TILES="${batch_tiles}" \
