...
remote_root="${EXP0054_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0054}"
mode="${1:-control}"
repeat_count="${2:-1}"
...
case "${mode}" in
    control) qkvo_mode=qkvo_batch4_qk_head_tasks ;;
    candidate) qkvo_mode=qkvo_batch4_qkv_head_tasks ;;
    *)
