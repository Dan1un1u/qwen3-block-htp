...
R=Path('/mnt/d/llm_exp/results/qwen3-block-htp/exp0263');old=R.parent/'exp0262'
sha=lambda p:hashlib.sha256(p.read_bytes()).hexdigest()
assert sha(old/'EVIDENCE_SHA256.json')=='d526f6193fabb6b4cd7279c55907b06c2fcebcbcf9a875ec934c6e55fe2fe1de'
...
def main():
 ...
 preflight()
 results=[check(tag,old/'audit_a1') for tag in ['audit_previous','audit_parallel','audit_stream','audit_previous_final','audit_a1']]
 ...
 gate['parent_numerical_seal']='d526f6193fabb6b4cd7279c55907b06c2fcebcbcf9a875ec934c6e55fe2fe1de'
