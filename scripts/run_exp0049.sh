...
case "${mode}" in
    control)
        remote_root="${EXP0049_CONTROL_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0049-control}"
        ;;
    candidate)
        remote_root="${EXP0049_CANDIDATE_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0049-candidate}"
        ;;
    *)
