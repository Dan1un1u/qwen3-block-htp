...
overlay="${QBH_EXP0170_OVERLAY:-/mnt/d/llm_exp/models/qwen3-block-htp/exp0169/w4u8_greedy193_overlay}"
remote_root="${EXP0170_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0170-w4u8}"
remote_transformer="${EXP0170_REMOTE_TRANSFORMER:-/data/local/tmp/qwen3-block-htp/exp0163-candidate/block_package_layer14_m64}"
remote_generation="${EXP0170_REMOTE_GENERATION:-/data/local/tmp/qwen3-block-htp/exp0168-w4u8/block_package_layer14_m64}"
stage_root="${QBH_EXP0170_ADB_STAGE:-/mnt/d/llm_exp/models/qwen3-block-htp/.adb-staging/exp0170}"
archive="${stage_root}/overlay.tar"

case "${remote_root}" in
/data/local/tmp/qwen3-block-htp/exp0170-*) ;;
*) printf 'unsafe EXP-0170 remote root: %s\n' "${remote_root}" >&2; exit 2 ;;
esac
