...
fp16_remote="${EXP0107_FP16_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0107-fp16}"
u8_remote="${EXP0107_U8_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0107-u8}"
