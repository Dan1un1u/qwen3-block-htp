...
import json,hashlib,yaml,os
from pathlib import Path
BASE=Path('/mnt/d/llm_exp/results');R=Path(os.environ.get('QBH_PAPER_REPORT_ROOT',str(BASE/'paper-no-rotation-ablation-20260915')));R.mkdir(parents=True,exist_ok=True)
