...
cell="${1:?EXP-0196 cell required}"
case "${cell}" in
    expanded16) group_tiles=16; direct_mask=7 ;;
    direct32) group_tiles=32; direct_mask=15 ;;
    *) printf 'invalid EXP-0196 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
EXP0173_REMOTE_ROOT=/data/local/tmp/qwen3-block-htp/exp0173-exp0196-lm-head-direct-n-batch32 \
...
QBH_W4U8_DECODE_DIRECT_N_MASK="${direct_mask}" \
