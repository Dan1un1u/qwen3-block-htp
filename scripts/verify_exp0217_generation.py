#!/usr/bin/env python3
"""Verify repeated EXP-0217 device generation logs and decode the tokens."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "/mnt/d/llm_exp/results/qwen3-block-htp/exp0217/semantic_reference.json"
        ),
    )
...
def main() -> None:
    ...
    expected = semantic["f16f16"]["token_ids"]
    ...
    result = {
        ...
        "independent_expected_text": semantic["f16f16"]["text"],
