...
from device_exp0285 import adb,win,records
...
def validate(d,fp,repeat,audit=False):
 ...
 for step,v in enumerate(ps):
  ...
  assert v['boundary_ddr_write_bytes']==(2048*(66 if fp==3 else 68 if fp else 1) if audit else 0)
