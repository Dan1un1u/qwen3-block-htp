...
case "${mode}" in
    control)
        package="${QBH_EXP0159_CONTROL_PACKAGE:-/mnt/d/llm_exp/models/qwen3-block-htp/exp0156/w4u8_hmx_native_v1}"
        ;;
    candidate)
...
stage_root="${QBH_EXP0159_ADB_STAGE:-/mnt/d/llm_exp/models/qwen3-block-htp/.adb-staging/exp0159}"
