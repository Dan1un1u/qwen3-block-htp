...
grep -q 'QBH_BLOCK_EXPERIMENT UINT32_C(98)' \
    "${project_root}/include/block_protocol.h"
...
printf '%s\n' '{"experiment":"EXP-0098","static_gate":"pass","control_down_batch_outputs":1,"candidate_down_batch_outputs":2,"candidate_expected_down_commands":32,"candidate_expected_total_hmx_commands":144,"in_command_first_and_continuation_slot_release":true,"whole_batch_preready_barrier":false,"qnn_dependency":false}'
