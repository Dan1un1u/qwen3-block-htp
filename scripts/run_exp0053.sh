...
remote_root="${EXP0053_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0053}"
mode="${1:-control}"
repeat_count="${2:-1}"
...
case "${mode}" in
    control) residual_mode=fused ;;
    candidate) residual_mode=fused_pool4 ;;
    *)
