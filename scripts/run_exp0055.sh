...
remote_root="${EXP0055_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0055}"
mode="${1:-control}"
repeat_count="${2:-1}"
...
case "${mode}" in
    control) qk_mode=qkvo_batch4_qk_head_tasks ;;
    candidate) qk_mode=qkvo_batch4_qk_head_pairs ;;
    *)
