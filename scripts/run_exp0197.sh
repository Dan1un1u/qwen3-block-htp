...
cell="${1:?EXP-0197 cell required}"
case "${cell}" in
    direct32) group_tiles=32 ;;
    direct64) group_tiles=64 ;;
    *) printf 'invalid EXP-0197 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
EXP0173_REMOTE_ROOT=/data/local/tmp/qwen3-block-htp/exp0173-exp0197-lm-head-direct-n-batch64 \
