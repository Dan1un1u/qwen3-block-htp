...
cell="${1:?EXP-0191 cell required}"
case "${cell}" in
    batch8) batch_tiles=8 ;;
    batch16) batch_tiles=16 ;;
    *) printf 'invalid EXP-0191 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
EXP0173_REMOTE_ROOT=/data/local/tmp/qwen3-block-htp/exp0173-exp0191-gate-up-batch16 \
