...
package="${QBH_EXP0167_PACKAGE:-/mnt/d/llm_exp/models/qwen3-block-htp/exp0167/w4u8_greedy16}"
remote_root="${EXP0167_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0167-w4u8}"
stage_root="${QBH_EXP0167_ADB_STAGE:-/mnt/d/llm_exp/models/qwen3-block-htp/.adb-staging/exp0167}"
