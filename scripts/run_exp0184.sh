...
cell="${1:?EXP-0184 cell required}"
case "${cell}" in
    control) cache_layout=hmx_native_u8_segmented_vtcm_tail_v7; poison=0 ;;
    k_tail) cache_layout=hmx_native_u8_segmented_vtcm_k7_v8; poison=0 ;;
    k_tail_poison) cache_layout=hmx_native_u8_segmented_vtcm_k7_v8; poison=1 ;;
    *) printf 'invalid EXP-0184 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
EXP0173_REMOTE_ROOT=/data/local/tmp/qwen3-block-htp/exp0173-exp0184-w4u8 \
