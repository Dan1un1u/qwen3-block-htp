...
def execute(mode,tag,nl=28,repeat=1,audit=False,poison=False):
    ...
    d.mkdir(exist_ok=True);binary_mode='Id';root=REMOTE+f'/binaries-{binary_mode}-{nl}';base=read(BASE)
...
if __name__=='__main__':
 ...
 if a.action=='audit':preflight();execute(a.mode,f'audit-d-{a.layers}-{a.mode}',nl=a.layers,audit=True)
