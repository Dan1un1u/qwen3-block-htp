#!/usr/bin/env python3
"""Validate and summarize EXP-0211 direct-W4 Down8 single-DMA evidence."""
...
EXPERIMENT = 211
LAYERS = 28
DOWN_BATCHES = {CONTROL: 4, CANDIDATE: 8}
DOWN_COMMANDS = {CONTROL: 448, CANDIDATE: 224}
Q_BATCHES = {CONTROL: 32, CANDIDATE: 32}
QKV_COMMANDS = {CONTROL: 168, CANDIDATE: 168}
O_BATCHES = {CONTROL: 16, CANDIDATE: 16}
O_COMMANDS = {CONTROL: 112, CANDIDATE: 112}
O_SINGLE_DMA = {CONTROL: 1, CANDIDATE: 1}
...
def main() -> None:
    ...
    gates = {
        ...
        "down_projection_wall_faster":
            down_projection[CANDIDATE] < down_projection[CONTROL],
        ...
        "direct_hmx_command_delta_exact":
            ...
            physical["candidate_direct_n_hmx_commands"] == 224,
        ...
        "dma_descriptor_delta_exact":
            ...
            physical["candidate_dma_descriptors"] == 448,
    ...
    summary = {
        ...
        "down_projection_us": down_projection,
        "prefetch": prefetch,
        "stream": stream,
        "physical": physical,
        "audit": audit,
    ...
    report = [
        "# EXP-0211 direct-W4 Down8 single-DMA report",
        "",
        f"Source commit: `{args.source_commit}`",
        "",
        "Both cells inherit the evidence-valid EXP-0210 enabling candidate, "
        "including Q32/KV16, O batch16 single-DMA and all prior decode "
        "optimizations. The only runtime difference is Down batch4 versus "
        "Down batch8; both use one complete packed-W4 descriptor chained to "
        "one bias descriptor.",
        "",
        "## End-to-end gate",
        "",
        "| Metric | Down4 control | Down8 candidate | Change |",
        "|---|---:|---:|---:|",
        ...
        *pair_rows,
        ...
        "",
        "| Module | Down4 control | Down8 candidate | Candidate speed change |",
        "|---|---:|---:|---:|",
        *module_rows,
        ...
        "",
        f"Down projection wall: {down_projection[CONTROL]:.1f} -> "
        f"{down_projection[CANDIDATE]:.1f} us/token. Prefetch: "
