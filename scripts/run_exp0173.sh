...
decode_direct_n_down_dma_batch_tiles="${QBH_W4U8_DECODE_DIRECT_N_DOWN_DMA_BATCH_N_TILES:-2}"
...
case "${decode_direct_n_down_dma_batch_tiles}" in
2|4) ;;
*) printf 'invalid direct-n Down DMA batch tiles: %s\n' "${decode_direct_n_down_dma_batch_tiles}" >&2; exit 2 ;;
esac
