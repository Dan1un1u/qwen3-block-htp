...
kv_cache_layout="${QBH_EXP0182_KV_CACHE_LAYOUT:-${QBH_EXP0181_KV_CACHE_LAYOUT:-${QBH_EXP0180_KV_CACHE_LAYOUT:-hmx_native_u8_segmented_v4}}}"
...
hmx_native_u8_segmented_v4|hmx_native_u8_segmented_quartet_v5|hmx_native_u8_segmented_attention_publish_v6|hmx_native_u8_segmented_vtcm_tail_v7) ;;
*) printf 'invalid EXP-0180/0181/0182 KV-cache layout: %s\n' "${kv_cache_layout}" >&2; exit 2 ;;
esac
