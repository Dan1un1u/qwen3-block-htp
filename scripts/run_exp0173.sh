...
hmx_native_u8_segmented_v4|hmx_native_u8_segmented_quartet_v5|hmx_native_u8_segmented_attention_publish_v6|hmx_native_u8_segmented_vtcm_tail_v7|hmx_native_u8_segmented_vtcm_k7_v8) ;;
