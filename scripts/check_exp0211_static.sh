...
grep -q '#define QBH_BLOCK_EXPERIMENT UINT32_C(211)' include/block_protocol.h
...
grep -q 'QBH_W4U8_DECODE_DIRECT_N_GATE_UP_SWIGLU_STREAM' \
    src/host/block_main.c scripts/run_exp0173.sh scripts/run_exp0211.sh
grep -q 'QBH_W4U8_DECODE_DIRECT_N_QKV_BATCH_N_TILES=16' scripts/run_exp0211.sh
grep -q 'QBH_W4U8_DECODE_DIRECT_N_Q_BATCH_N_TILES=32' scripts/run_exp0211.sh
grep -q 'QBH_EXP0176_O_BATCH_TILES=16' scripts/run_exp0211.sh
...
bash -n scripts/build_exp0211.sh scripts/deploy_exp0211.sh \
    scripts/run_exp0211.sh scripts/run_exp0211_short_gate.sh \
    scripts/run_exp0211_formal.sh scripts/check_exp0211_static.sh
python3 -m py_compile scripts/summarize_exp0189.py scripts/summarize_exp0211.py
printf '%s\n' '{"experiment":"EXP-0211","static_gate":"pass","candidate":"direct-W4-Down8-single-DMA","qnn_dependency":false}'
