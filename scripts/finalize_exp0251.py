...
for cell,pin in [('control','8f42f9e07f49d90504f8845e9f01ffc796c133c567794d8bf15af8778f93eaff'),('r3','c196670085429fb749cd2c391fa3d4c79eee9c3644a222cce3def002475609f1')]:
 root=Path('/mnt/d/llm_exp/models/qwen3-block-htp/exp0247')/cell;p=root/'device_manifest.json';assert sha(p)==pin;models[cell]=dict(manifest_sha256=pin,manifest=json.loads(p.read_text()))
