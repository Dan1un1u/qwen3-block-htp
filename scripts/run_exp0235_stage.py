...
def main():
    ...
    modules={'data':('data_exp0235.py',[]),'evaluate':('evaluate_exp0235.py',[]),'summary':('summarize_exp0235.py',[])}
    ...
    archive=Path('/mnt/d/llm_exp/models/qwen3-block-htp/exp0235/artifacts')/head/'source.tar'
