...
cell="${1:?EXP-0208 cell required}"
case "${cell}" in
    qsplit3) qkv_single_dma=0 ;;
    qsingle2) qkv_single_dma=1 ;;
    *) printf 'invalid EXP-0208 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
...
QBH_W4U8_DECODE_DIRECT_N_QKV_SINGLE_DMA="${qkv_single_dma}" \
