...
grep -q 'QBH_BLOCK_W4U8_DECODE_GATE_UP_PAIR_READY_BATCH16' include/block_protocol.h
...
grep -q 'QBH_BLOCK_W4U8_GATE_UP_PAIR_READY_HVX_WORKERS UINT32_C(4)' src/dsp/block_imp.c
...
printf '%s\n' '{"experiment":"EXP-0175","static_gate":"pass","variant":"W4U8","control":"post_batch8","candidates":["pair_ready_batch8","pair_ready_batch16"],"qnn_dependency":false}'
