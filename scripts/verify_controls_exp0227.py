...
def main():
    ...
    for v,path,remote,expected in [('A0','exp0224/A','exp0224-A',old['packages']['A']['manifest_sha256']),('R0','exp0225/step100','exp0225-step100','44ac941297f1aab82ec4daff2ca8191379def73f6796a1c9c5d7d700820c5673')]:
        ...
        remote='/data/local/tmp/qwen3-block-htp/'+remote;check='/data/local/tmp/qwen3-block-htp/exp0227_'+v+'_verify.sha256'
