...
generation_mode="${QBH_EXP0168_GENERATION_MODE:-9}"
...
if [[ "${QBH_EXP0168_DEPLOY:-0}" == 1 ]]; then
    "${project_root}/scripts/deploy_exp0168.sh"
fi
