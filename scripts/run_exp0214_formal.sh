...
"${project_root}/scripts/build_exp0214.sh" > "${result_dir}/build.log" 2>&1
"${project_root}/scripts/check_exp0214_static.sh" > "${result_dir}/static_gate.json"
"${project_root}/scripts/deploy_exp0214.sh" > "${result_dir}/deploy.log" 2>&1
...
"${python_exe}" "${project_root}/scripts/summarize_exp0214.py" \
