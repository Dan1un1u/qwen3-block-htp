...
source_remote="/data/local/tmp/qwen3-block-htp/exp0158-w4f16/block_package_layer14_m64"
stage_root="${QBH_EXP0164_ADB_STAGE:-/mnt/d/llm_exp/models/qwen3-block-htp/.adb-staging/exp0164}"
...
for artifact in \
    ...
    "${package}/generation_lm_head_weight_w4_scale_f32.bin"; do
    test -f "${artifact}"
done
...
# Break only the EXP-0164 hard links before replacing cache carriers.  This
...
for name in \
    ...
    generation_lm_head_weight_w4_scale_f32.bin; do
