...
from device_exp0278_vsum import adb,win,stage
F=R.parent/'component-fixtures';ORIG=Path('/mnt/d/llm_exp/results/qwen3-block-htp/exp0277/selected-SP2-a01/step01_r3.bin')
...
def timing():
 ...
 for case in [c for c in m['cases'] if c['name'] in ['m64-p0-random','actual-g0']]:
