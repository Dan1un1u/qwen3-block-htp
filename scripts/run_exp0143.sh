...
remote_root="${EXP0143_REMOTE_ROOT:-/data/local/tmp/qwen3-block-htp/exp0143-u8}"
cell="${1:-control}"
repeat_count="${2:-1}"
...
runtime_args="2 32 rms_rope_softmax ${attribution_mode} ${audit_mode} fused_pool6_shuffle4 serial control hvx w4u8_streaming_persistent_mlp_hvx 3 64 ${u8_attention} 6 w4u8_mlp_io_qkv_o qkvo_batch4_qk_head_pairs hvx_tree_qk_batched_rsqrt_shared_rope_parallel_input control 4 4 4 ${qk_pair_mode}"
