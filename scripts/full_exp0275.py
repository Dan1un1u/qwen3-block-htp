...
from device_exp0275 import adb,win,records
...
def full(fp,repeat,tag,audit=False):
 ...
 pkg=read(R/'deployment-sp2-fp32.json')['remote'];e=dict(old.ENV,LD_LIBRARY_PATH=root,DSP_LIBRARY_PATH=root,ADSP_LIBRARY_PATH=root,QBH_SP2='8',QBH_U8_PREFILL_OPT='0',QBH_FP32_RESIDUAL=str(fp),QBH_PAPER_FORMAT_DISABLE=os.environ.get('QBH_PAPER_FORMAT_DISABLE','0'),QBH_PAPER_PIPELINE_DISABLE=os.environ.get('QBH_PAPER_PIPELINE_DISABLE','0'),QBH_WIDE_SCORE='4',QBH_DENSE_R3='0',QBH_DENSE_R4='0',QBH_KV_CACHE_CAPACITY='128',QBH_GENERATION_SEQUENCE='9',QBH_GENERATION_STEPS='16',QBH_PREFIX_KV='1',QBH_PREFIX_FILE=SEED)
