...
def layer(x,p,cos,sin,past=None,sp2=True):
 ...
 for group in range(8):
  c=config(tuple(int(a) for a in cfg[group]));res=numpy_oracle(qr[:,2*group:2*group+2].transpose(1,0,2),k[group],v[group],valid,c,'wide_float')
