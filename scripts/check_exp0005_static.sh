...
printf '{"experiment":"EXP-0005","integer_hmx":true,'
printf '"u8_activation":true,"packed_signed_w4":true,'
printf '"per_output_channel_integer_scale":true,'
printf '"hvx_nibble_lut":true,"user_dma":true,'
printf '"double_buffered_compressed_weights":true,'
printf '"double_buffered_expanded_weights":true,'
