...
def main():
 ...
 # All native code in the measured ABI123 binary must remain unchanged.
 ...
 docs=S/'docs/experiments';(docs/'EXP-0261-RESULTS.md').write_text(report);(docs/'EXP-0261-PROFILE.md').write_text((R/'FULL_PROFILING_REPORT.md').read_text())
