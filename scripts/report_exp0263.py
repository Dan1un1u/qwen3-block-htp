...
def main():
 ...
 # All native code in the measured ABI126 binary must remain unchanged.
 ...
 lines+=['','Historical EXP0262 comparison (separate campaigns, not paired inference):','', '|Mode|Previous R4 us|Optimized R4 us|Observed speedup|','|---|---:|---:|---:|']
 ...
 docs=S/'docs/experiments';(docs/'EXP-0263-RESULTS.md').write_text(report);(docs/'EXP-0263-PROFILE.md').write_text((R/'FULL_PROFILING_REPORT.md').read_text())
