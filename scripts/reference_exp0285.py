...
def layer(x,p,cos,sin,past=None,sp2=True,seed=None):
 ...
 av=av.reshape(-1,2048);o=project(av,p,'o',2048,q['attention_concat'],None,True);res=(x+o).astype("f2").astype("f4")
 ...
 down=project(mid,p,'down',2048,q['middle'],None,True);y=(res+down).astype("f2").astype("f4")
