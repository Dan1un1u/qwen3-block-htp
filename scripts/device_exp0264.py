...
R=R.parent/'exp0264'
base.R=R;base.REMOTE='/data/local/tmp/qwen3-block-htp/exp0264'
...
def run(arm,rep,tag,dump=False,opt=6):
...
if __name__=='__main__':
 p=argparse.ArgumentParser();p.add_argument('action');p.add_argument('--arm',type=int,default=0);p.add_argument('--repeat',type=int,default=1);p.add_argument('--tag',default='smoke');p.add_argument('--dump',action='store_true');p.add_argument('--opt',type=int,default=6);a=p.parse_args()
