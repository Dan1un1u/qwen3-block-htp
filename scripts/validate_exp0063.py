#!/usr/bin/env python3
"""Validate EXP-0063 fused QK requantization and Softmax evidence."""
...
import validate_exp0062 as previous
...
def build_summary(result_dir: Path, package_dir: Path) -> dict[str, object]:
    if "u8_attention_qk_requant_softmax_ticks" not in base.OVERLAP:
        base.OVERLAP += ("u8_attention_qk_requant_softmax_ticks",)
