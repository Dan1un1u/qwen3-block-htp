...
cd "$root"
build_cmake android BUILD=ReleaseG QBH_MODEL_LLAMA32=OFF QBH_NATIVE_SP2=ON QBH_QWEN_MODEL_SIZE=${QBH_QWEN_MODEL_SIZE:-1.7B} QBH_PAPER_TRACE=${QBH_PAPER_TRACE:-OFF} QBH_EXP0247_DENSE_R3=OFF QBH_EXP0240_SINGLE_LAYER=OFF QBH_EXP0257_LAYER_COUNT=${1:-28} -j8
build_cmake hexagon BUILD=ReleaseG DSP_ARCH=v79 QBH_MODEL_LLAMA32=OFF QBH_NATIVE_SP2=ON QBH_QWEN_MODEL_SIZE=${QBH_QWEN_MODEL_SIZE:-1.7B} QBH_PAPER_TRACE=${QBH_PAPER_TRACE:-OFF} QBH_EXP0247_DENSE_R3=OFF QBH_EXP0240_SINGLE_LAYER=OFF QBH_EXP0257_LAYER_COUNT=${1:-28} -j8
