...
write(R/'summary.json',summary);write(R/'numeric_diagnostics.json',dict(data=data,loops=loops));write(R/'independent_integrity_checks.json',dict(pass_all=True,timed_RPCs=calls,layer_ledgers=calls*28,all_selected_sequences_exact=True,R3_calls_28_per_step=True,R3_live_rows_prefill=43008,R3_live_rows_decode=672,all_native_W4_projection_counts_prefill196_decode197=True,physical_and_ledgers=True,independent_statistics_CI_recomputed=True,historical_hashes_verified=20))
