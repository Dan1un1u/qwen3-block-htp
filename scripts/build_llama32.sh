...
cd "$root"
build_cmake android BUILD=ReleaseG QBH_MODEL_LLAMA32=ON QBH_LLAMA_MODEL_SIZE=${QBH_LLAMA_MODEL_SIZE:-1B} QBH_PAPER_TRACE=${QBH_PAPER_TRACE:-OFF} QBH_LLAMA_LAYER_COUNT=${1:-16} -j8
build_cmake hexagon BUILD=ReleaseG DSP_ARCH=v79 QBH_MODEL_LLAMA32=ON QBH_LLAMA_MODEL_SIZE=${QBH_LLAMA_MODEL_SIZE:-1B} QBH_PAPER_TRACE=${QBH_PAPER_TRACE:-OFF} QBH_LLAMA_LAYER_COUNT=${1:-16} -j8
