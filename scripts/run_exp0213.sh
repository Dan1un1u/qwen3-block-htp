...
cell="${1:?EXP-0213 cell required}"
case "${cell}" in
    control) next_q_prefetch=0 ;;
    next_q) next_q_prefetch=1 ;;
    *) printf 'invalid EXP-0213 cell: %s\n' "${cell}" >&2; exit 2 ;;
esac
...
QBH_W4U8_DECODE_DIRECT_N_Q_BATCH_N_TILES=32 \
QBH_W4U8_DECODE_DIRECT_N_DOWN_BATCH_N_TILES=8 \
QBH_W4U8_DECODE_DIRECT_N_DOWN_SINGLE_DMA=1 \
QBH_W4U8_DECODE_DIRECT_N_O_SINGLE_DMA=1 \
QBH_W4U8_DECODE_DIRECT_N_NEXT_Q_PREFETCH="${next_q_prefetch}" \
