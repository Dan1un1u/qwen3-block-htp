...
if __name__=='__main__':
 ap=argparse.ArgumentParser();ap.add_argument('action',choices=['prepare','run']);ap.add_argument('--layer',type=int,default=0);ap.add_argument('--arm',choices=['off','r3','r4','both'],required=True);ap.add_argument('--attempt',required=True);ap.add_argument('--package');ap.add_argument('--audit',action='store_true');ap.add_argument('--r4-mode',type=int,choices=[1,3],default=1);ap.add_argument('--result-experiment',default='l32-0019');a=ap.parse_args();assert a.result_experiment in ['l32-0019','l32-0020','l32-0021','l32-0022','l32-0023','l32-0024','l32-0025'];R=R.parent/a.result_experiment;globals()[a.action](a)
