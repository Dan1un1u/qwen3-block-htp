...
from long_prefill_3b_oracle import fnv
from llama32_3b_reference import layer,norm,H
...
def main(length,decode,tag):
 ...
 for i in range(28):
  lp=p/f'layer{i}';q=load_qparams_bin(lp/'qparams_u8.bin');x,kv,_=layer(x,lp,q,cos,sin)
 ...
 act=norm(x[indices],gamma,gq['generation_final_norm_output']);cv=HmxU8Converter(S/'build/l32-0003/qbh_hmx_u8_reference.so')
