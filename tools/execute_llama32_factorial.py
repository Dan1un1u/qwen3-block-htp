"""L32-0029 fixed full-model factorial, independent frozen references."""
...
R=Path('/mnt/d/llm_exp/results/llama32-htp/l32-0029');OLD=R.parent/'l32-0018';M=Path('/mnt/d/llm_exp/models/llama32-htp/l32-0016')
...
def preflight():
 ...
 assert 'ACTIVE_EXPERIMENT=L32-0029' in t

def prepare():
 preflight();ledger=OLD/'evidence-ledger-a01.json';assert sha(ledger)=='5572319f6bb94f623089199ef729a13c3c5d20b82134be14e75028ac707bd734'
...
def stage(count):
 ...
 d=R/f'binaries-l{count}-a{attempt}';d.mkdir();remote=f'/data/local/tmp/llama32-htp/l32-0029-l{count}-a{attempt}'
