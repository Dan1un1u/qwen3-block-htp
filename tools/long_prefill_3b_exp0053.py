"""L32-0053 isolated long-prefill fixtures, build deployment and immutable runs."""
...
R=Path('/mnt/d/llm_exp/results/llama32-htp/l32-0053')
M=Path('/mnt/d/llm_exp/models/llama32-htp/l32-0053')
BASE=R/'base.json'
REMOTE='/data/local/tmp/llama32-htp/l32-0053'
...
def preflight():
 ...
 assert 'ACTIVE_EXPERIMENT=L32-0053' in z
def prepare():
 preflight()
 import torch
 ...
 for length in [64,65,128,129,536,741]:
  ...
  put(dst/'manifest.json',dict(experiment='L32-0053',parent=base,parent_sha256=base['manifest_sha256'],files=files,changed=changed))
