...
R=Path('/mnt/d/llm_exp/results/llama32-htp/l32-0033')
ID='L32-0033';LAYERS=16;SEED=30033;DELTA=0
STDOUT='stdout.txt'
...
lines += ['',f'M64+15，{LAYERS} 层。fixed 行为受控输入重放，greedy 为实际自由生成路径，两者不混合。',out['numerical_gate_scope'],'相同 HMX 工作量与权重 DDR 字节，无中间 tensor DDR/spill，8 MiB VTCM。FP32 向量 exp/归约/概率码行和使用供应商 QHL HVX；组件输出门槛独立记录。未做模型质量/PPL 验收，不晋升基线。A8 额外支持 shape 仍待执行。']
