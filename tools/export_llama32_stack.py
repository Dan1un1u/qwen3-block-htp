...
def main():
    ...
    for i in range(args.layers):
        ...
        for name,key in PROJECTIONS.items():write(out/f"{name}_weight_f16_hmx.bin",pack_weight(w[f"model.layers.{i}.{key}.weight"]))
