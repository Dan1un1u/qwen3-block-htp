#!/usr/bin/env python3
"""L32-0045 no-performance-gate 3B optimization against frozen L32-0041 payloads."""
...
def stage(tag):
    ...
    d=R/tag;d.mkdir(exist_ok=False);remote='/data/local/tmp/llama32-htp/l32-0045/'+tag
