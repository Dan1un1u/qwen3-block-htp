...
for n in ['block_input_u8.bin','reference_w4u8_integer_attention_block_output_u8.bin','rope_cos_f16.bin','rope_sin_f16.bin']:os.link(p/n,out/("reference_w4u8_block_input_u8.bin" if n=="block_input_u8.bin" else n))
