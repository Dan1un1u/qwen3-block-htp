...
fig,axes=plt.subplots(1,2,figsize=(8.6,3.3),layout='constrained');colors=['#64748b','#0284c7'];rng=np.random.default_rng(29029);idx=rng.integers(0,10,(20000,10))
...
axes[0].legend(frameon=False,fontsize=8);fig.suptitle('Llama: full-model format × pipeline ablation',fontsize=12)
