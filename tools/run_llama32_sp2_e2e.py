#!/usr/bin/env python3
"""L32-0010 same-build U8/SP2 all-layer M64+15 fixed ten AB/BA pairs."""
...
OUT=Path('/mnt/d/llm_exp/results/llama32-htp/l32-0010/e2e-a01')
MODELS=Path('/mnt/d/llm_exp/models/llama32-htp')
REMOTE='/data/local/tmp/llama32-htp/l32-0010/e2e-a01'
def save(p,v):
...
def deploy():
 ...
 for arm,local in [('u8',base),('sp2',MODELS/'l32-0010/frontend-a01')]:
  ...
  teacher=OUT.parent/'sp2-oracle.json' if arm=='sp2' else OUT.parent.parent/'l32-0003/frontend-reference-a01/teacher.json';assert sha256(teacher)==m['frontend_teacher_sha256']
...
def formal():
 ...
 rng=np.random.default_rng(10010);idx=rng.integers(0,10,size=(20000,10));report={}
