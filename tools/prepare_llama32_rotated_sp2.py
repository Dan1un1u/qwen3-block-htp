...
NEW=BASE.parent.parent/'l32-0015/rotated-down-a01'
...
def main():
 ...
 save(NEW/'manifest.json',dict(experiment='L32-0015',original=prov,baseline_manifest_sha256=sha256(BASE/'manifest.json'),calibration_freeze_sha256=sha256(DATA/'freeze.json'),layers=report))
