...
static int qbh_run_chunked_w4_pipeline_impl(
    ...
    if (handoff != NULL &&
        (layout->variant != QBH_PROJECTION_GATE_UP_PAIR ||
         ...
         handoff->pair_slot_count > QBH_W4_MAX_PAIR_SLOT_COUNT ||
