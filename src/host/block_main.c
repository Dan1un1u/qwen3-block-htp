...
int main(int argc, char **argv) {
    ...
    uint32_t w4u8_qkv_batch_n_tiles_config = 4U;
    ...
    if (argc < 3 || argc > 25 ||
        ...
        (argc >= 25 && qbh_parse_u32(
                           argv[24],
                           &w4u8_qkv_batch_n_tiles_config) != 0) ||
        ...
        (w4u8_qkv_batch_n_tiles_config != 4U &&
         w4u8_qkv_batch_n_tiles_config != 8U) ||
        (variant != QBH_BLOCK_W4U8 &&
         w4u8_qkv_batch_n_tiles_config != 4U) ||
        (variant == QBH_BLOCK_W4U8 &&
         fp16_common_schedule_mode !=
    ...
    header->w4u8_qkv_batch_n_tiles_config =
        w4u8_qkv_batch_n_tiles_config;
    ...
    printf(
        ...
        "\"w4u8_qkv_batch_n_tiles_config\":%" PRIu32 ","
        "\"attribution_mode\":\"%s\","
        ...
        "\"w4u8_qkv_batch_n_tiles_observed\":%" PRIu32 ","
        "\"w4u8_q_ready_publish_count\":%" PRIu32 ","
        "\"w4u8_k_ready_publish_count\":%" PRIu32 ","
        ...
        header->w4u8_qkv_batch_n_tiles_observed,
