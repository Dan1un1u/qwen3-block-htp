...
int main(int argc, char **argv) {
    ...
    if (argc < 3 || argc > 25 ||
        ...
        fprintf(stderr, "usage: %s PACKAGE_DIR VARIANT [repeat_count] "
                        ...
                        "[w4u8_softmax_reduction_mode:0|1]\n",
                argv[0]);
        return 2;
    }
    ...
    printf(
        ...
        "\"w4u8_softmax_reduction_mode\":%" PRIu32 ","
        ...
        "\"w4u8_softmax_reduction_mode_observed\":%" PRIu32 ","
        "\"w4u8_softmax_dual_head_row_count\":%" PRIu32 ","
