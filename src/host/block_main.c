...
static int qbh_parse_w4u8_qkvo_pipeline_mode(
    ...
    if (strcmp(text,
               "qkvo_batch4_qk_head_pairs_q_worker_expand") == 0 ||
        strcmp(text, "q_worker_expand") == 0) {
        *mode =
...
static const char *qbh_w4u8_qkvo_pipeline_mode_name(uint32_t mode) {
    switch (mode) {
        ...
        case QBH_BLOCK_W4U8_QKVO_BATCH4_QK_HEAD_PAIRS_Q_WORKER_EXPAND:
            return "qkvo_batch4_qk_head_pairs_q_worker_expand";
        default:
            return "serial";
    }
}
...
int main(int argc, char **argv) {
    ...
    printf(
        ...
        "\"w4u8_qkv_worker_assist_tile_count\":%" PRIu32 ","
        "\"w4u8_qkv_main_expand_tile_count\":%" PRIu32 ","
        ...
        header->w4u8_qkv_main_expand_tile_count,
