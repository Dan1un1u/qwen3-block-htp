...
struct qbh_probe_header {
    ...
    uint64_t mlp_activation_queue_claim_count;
    uint64_t mlp_activation_queue_wait_ticks;
    uint64_t mlp_activation_queue_wait_max_ticks;
    uint64_t mlp_activation_queue_tasks_ahead_sum;
    uint64_t mlp_activation_queue_tasks_ahead_max;
    uint64_t mlp_activation_queue_depth_max;
};

_Static_assert(sizeof(struct qbh_probe_header) == 664,
