...
#ifdef QBH_LLAMA_3B
#define QBH_GATE_UP_K UINT32_C(3072)
#else
...
#ifdef QBH_MODEL_LLAMA32
#define QBH_QWEN3_HMX_PAIRS_PER_REPEAT (QBH_GATE_UP_K * QBH_GATE_UP_N / 1024U)
#define QBH_QWEN3_PAIRED_HMX_PAIRS_PER_REPEAT (2U * QBH_QWEN3_HMX_PAIRS_PER_REPEAT)
#else
