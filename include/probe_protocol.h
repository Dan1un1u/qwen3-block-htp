...
#ifdef QBH_QWEN_06B
#define QBH_GATE_UP_K UINT32_C(1024)
#else
#define QBH_GATE_UP_K UINT32_C(2048)
#endif
#ifdef QBH_MODEL_LLAMA32
#define QBH_GATE_UP_N UINT32_C(8192)
#define QBH_GATE_UP_PAIR_N UINT32_C(16384)
#define QBH_DOWN_K UINT32_C(8192)
#else
#ifdef QBH_QWEN_06B
#define QBH_GATE_UP_N UINT32_C(3072)
#define QBH_GATE_UP_PAIR_N UINT32_C(6144)
#define QBH_DOWN_K UINT32_C(3072)
#else
...
#define QBH_DOWN_N QBH_GATE_UP_K
...
#ifdef QBH_MODEL_LLAMA32
#define QBH_QWEN3_HMX_PAIRS_PER_REPEAT UINT32_C(16384)
#define QBH_QWEN3_PAIRED_HMX_PAIRS_PER_REPEAT UINT32_C(32768)
#else
#ifdef QBH_QWEN_06B
#define QBH_QWEN3_HMX_PAIRS_PER_REPEAT UINT32_C(3072)
#define QBH_QWEN3_PAIRED_HMX_PAIRS_PER_REPEAT UINT32_C(6144)
#else
