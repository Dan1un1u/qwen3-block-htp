...
struct qbh_probe_header {
    ...
    uint64_t mlp_middle_first_ready_tick;
    uint64_t mlp_middle_first_half_ready_tick;
    uint64_t mlp_middle_all_ready_tick;
    uint64_t hvx_worker_ticks[QBH_MAX_HVX_WORKERS];
};

_Static_assert(sizeof(struct qbh_probe_header) == 656,
