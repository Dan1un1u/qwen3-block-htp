...
#if defined(QBH_LLAMA_3B)
#define QBH_ATTENTION_HEAD_DIM UINT32_C(128)
#define QBH_ATTENTION_Q_HEADS_PER_GROUP UINT32_C(3)
#define QBH_ATTENTION_SCORE_TILES UINT32_C(2)
#define QBH_ATTENTION_HEAD_DIM_TILES UINT32_C(4)
#elif defined(QBH_MODEL_LLAMA32)
#define QBH_ATTENTION_HEAD_DIM UINT32_C(64)
#define QBH_ATTENTION_Q_HEADS_PER_GROUP UINT32_C(4)
#define QBH_ATTENTION_SCORE_TILES UINT32_C(2)
#define QBH_ATTENTION_HEAD_DIM_TILES UINT32_C(2)
#else
#define QBH_ATTENTION_HEAD_DIM UINT32_C(128)
