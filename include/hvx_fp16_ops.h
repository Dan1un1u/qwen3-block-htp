...
void qbh_hvx_long_softmax_f16_partition_tail(const __fp16 *, __fp16 *, uint32_t heads, uint32_t rows, uint32_t padded, uint32_t past, float scale, float *scratch, uint32_t first, uint32_t stride);
void qbh_hvx_long_softmax_f16_native_partition(const __fp16 *, __fp16 *, uint32_t heads, uint32_t rows, uint32_t padded, uint32_t past, float scale, float *scratch, uint32_t first, uint32_t stride);
