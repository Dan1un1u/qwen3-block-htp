...
#define QBH_BLOCK_EXPERIMENT UINT32_C(97)
...
enum qbh_block_mlp_mode {
    ...
    QBH_BLOCK_MLP_W4U8_STREAMING_PERSISTENT_MLP_HVX_EXACT_AFFINE = 8,
};
...
static inline uint32_t qbh_block_mlp_uses_exact_affine_activation(
    uint32_t mode) {
    return mode ==
           QBH_BLOCK_MLP_W4U8_STREAMING_PERSISTENT_MLP_HVX_EXACT_AFFINE;
}
...
struct qbh_block_header {
    ...
    uint32_t w4u8_mlp_exact_affine_activation_task_count;
