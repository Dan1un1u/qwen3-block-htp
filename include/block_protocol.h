...
#define QBH_BLOCK_EXPERIMENT UINT32_C(171)
...
enum qbh_w4u8_decode_swiglu_mode {
    QBH_BLOCK_W4U8_DECODE_SWIGLU_FULL_TILE = 0,
    QBH_BLOCK_W4U8_DECODE_SWIGLU_ROW4 = 1,
};
...
struct qbh_block_header {
    ...
    uint32_t w4u8_decode_swiglu_row4_mismatch_count;
