...
#define QBH_BLOCK_EXPERIMENT UINT32_C(105)
...
enum qbh_block_w4u8_softmax_reduction_mode {
    QBH_BLOCK_W4U8_SOFTMAX_REDUCTION_SERIAL_HEADS = 0,
    QBH_BLOCK_W4U8_SOFTMAX_REDUCTION_DUAL_HEAD = 1,
};
...
struct qbh_block_header {
    ...
    uint32_t w4u8_softmax_reduction_mode;
    ...
    uint32_t w4u8_softmax_reduction_mode_observed;
    uint32_t w4u8_softmax_dual_head_row_count;
