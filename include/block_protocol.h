...
#define QBH_BLOCK_EXPERIMENT UINT32_C(202)
...
struct qbh_block_header {
    ...
    uint32_t w4u8_decode_direct_n_down_prefetch;
    ...
    uint32_t w4u8_down_prefetch_start_count;
    uint32_t w4u8_down_prefetch_consume_count;
    uint32_t w4u8_down_prefetch_overlap_count;
    uint64_t w4u8_down_prefetch_dma_ticks;
    uint64_t w4u8_down_prefetch_lifetime_ticks;
