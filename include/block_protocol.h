...
#define QBH_BLOCK_EXPERIMENT UINT32_C(131)
...
enum qbh_block_w4u8_qkv_tail_prep_mode {
    QBH_BLOCK_W4U8_QKV_TAIL_PREP_CONTROL = 0,
    QBH_BLOCK_W4U8_QKV_TAIL_PREP_MAIN_DRAIN = 1,
};
