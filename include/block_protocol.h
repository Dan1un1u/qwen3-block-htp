...
#ifdef QBH_QWEN_06B
#define QBH_BLOCK_HIDDEN UINT32_C(1024)
#else
...
#else
#ifdef QBH_QWEN_06B
#define QBH_BLOCK_INTERMEDIATE UINT32_C(3072)
#else
...
#endif
#define QBH_BLOCK_ATTN_WIDTH (QBH_BLOCK_HEADS * QBH_BLOCK_HEAD_DIM)
...
#define QBH_BLOCK_U8_ATTENTION_Q_BYTES \
    (QBH_BLOCK_M * QBH_BLOCK_ATTN_WIDTH)
