...
#define QBH_BLOCK_EXPERIMENT UINT32_C(77)
...
struct qbh_block_header {
    ...
    uint32_t w4u8_gate_up_cross_prefetch_count;
    uint64_t w4u8_gate_up_cross_prefetch_wait_ticks;
    uint64_t w4u8_gate_up_cross_prefetch_lifetime_ticks;
};
