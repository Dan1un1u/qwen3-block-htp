...
void qbh_attention_u8_pack_k_long_byte16(const uint8_t *rows,
 unsigned valid,unsigned padded,const struct qbh_attention_config *cfg,
 int8_t *weight,uint32_t *bias,uint8_t *scratch);
void qbh_attention_u8_pack_k_long_staged16(const uint8_t *rows,
 unsigned valid,unsigned padded,const struct qbh_attention_config *cfg,
 int8_t *weight,uint32_t *bias,uint8_t *scratch);
void qbh_attention_u8_pack_k_long_register(const uint8_t *,uint32_t,uint32_t,const struct qbh_attention_config *,int8_t *,uint32_t *);
...
void qbh_attention_u8_pack_v_long_register(const uint8_t *,uint32_t,uint32_t,const struct qbh_attention_config *,int8_t *,uint32_t *,uint8_t *,uint32_t *);
...
/* EXP-0180: convert one tile-major group of up to four logical V rows in
 * place to the exact integer-HMX weight carrier. */
